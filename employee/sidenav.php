...
<div class="navbar position-fixed d-flex flex-column" id="main-navbar">
    ...
    <div id="main-navbar">
        <ul class="nav nav1 flex-column w-100">
            ...
            <li class="nav-item">
                <a href="apply-leave.php" class="nav-link d-flex align-items-center ps-4">
                    <img src="../misc/apply-leave-icon.svg" alt="ApplyLeave icon">
                    <span class="mx-3">Apply Leave</span>
                </a>
            </li>
                            
            <li class="nav-item">
                <a href="pending-leave.php" class="nav-link d-flex align-items-center ps-3">
                    <img src="../misc/wait-icon.svg" alt="PendingLeave icon">
                    <span class="mx-3">Pending Leave</span>
                </a>
            </li> 
                    ...
                    <ul class="nav nav2 flex-column w-100">
                        ...
                        <li class="nav-item">
                            <a href="change-email.php" class="nav-link settings-content d-flex align-items-center">
                                <span class="mx-3 settings-content-btn">Change Email</span>
                            </a>
                        </li>
                        <li class="nav-item">
  ...
  <div class="container-fluid">
    ...
    <div class="sidebar order-lg-2 d-lg-flex w-100 pb-3 pb-lg-0">
        ...
        <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="apply-leave.php" class="nav-link d-flex align-items-center px-3 ps-4">
                    <img src="../misc/apply-leave-icon.svg" alt="ApplyLeave icon">
                    <span class="mx-3">Apply Leave</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="pending-leave.php" class="nav-link d-flex align-items-center px-3 ps-3">
                    <img src="../misc/wait-icon.svg" alt="PendingLeave icon">
                    <span class="mx-3">Pending Leave</span>
                </a>
            </li> 
