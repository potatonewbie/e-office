...
<head>
    ...
    <link rel="stylesheet" href="../css/employee/changeEmail.css">
...
<body>
    ...
    <div class="container-fluid bg-light">
        <div class="content">
            <h3 class="fw-bold">Change Email</h3>
                    ...
                    <?php 
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="form-floating col-8 mt-3">
                                <input id="new_pass_input" type="password" name="pass" class="form-control" placeholder="New Password">
                                <label for="new_pass_input">Password</label>
                            </div>
                        </div>
                        <div class="d-flex justify-content-center">
                            <div class="form-floating col-8 mt-3">
                                <input id="confirm_pass_input" type="password" name="conPass" class="form-control" placeholder="Confirm Password">
