...
<head>
    ...
    <link rel="stylesheet" href="../css/admin/changeNumber.css">
    ...
    <title>Change Admin Number</title>
</head>
<body>
    ...
    <div class="container-fluid bg-light">
        <div class="content">
            <h3 class="fw-bold">Change Admin Number</h3>
            <div class="card mt-3 p-3 overflow-auto text-nowrap">
                <form action="function/change-number.php" method="POST">
                    ...
                    <?php 
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="form-floating col-8 ">
                                <input id="new_num_input" type="text" name="empNo" class="form-control" placeholder="New Number" autocomplete="off">
                                <label for="new_num_input">New Number</label>
                            </div>
                        </div>
                        <div class="d-flex justify-content-center">
                            <div class="form-floating col-8 mt-3">
                                <input id="pass_input" type="password" name="pass" class="form-control" placeholder="pass">
